...
void main () {
	...
	if(nebula) {
		...
		// cannot remove this because the variable is redefined
		if(false) {
	...
	for(int i =0;i<8;++i){
		...
		// make planets animation
		// worldPosition.xyz = mix(worldPosition.xyz, trPos, sId);
		// prevent center from being too bright
	...
	// gl_PointSize =  min(maxS, 1000.0 * size / (-mvPos.z));
